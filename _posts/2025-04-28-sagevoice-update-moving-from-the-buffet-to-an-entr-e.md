---
title: " Moving from the buffet to an entrée"
date: 2025-04-28 12:50:00
...
I hope you’re doing well! I spent too much time on this week’s update, mostly making AI-enhanced images of myself (see below), so I’m going to skip next week’s. Try to get by without hearing from me.  😢

## From execution to research mode

With my basic requirements for the first pilots met, and still short of having validated revenue potential, I am going almost 100% on customer discovery in the pharma space.

Customer discovery sounds like a sales thing, but it’s actually a product thing: “_Customer discovery is a process of understanding potential customers and their needs to ensure a product or service is well-aligned with market demand”_

## Moving from the buffet to an entrée

Last week I showed you a simplified, but still complicated diagram of the clinical trials ecosystem. I called it an “intriguing buffet”. Last Tuesday, I met with Shruti and Dave (two entrepreneurs in this space–👋 Thanks!!! ) who helped me narrow down the focus and approach.

If you start with the value proposition,
...
This is still pretty broad. “Telephone interviews” can do a lot. They can support participant recruitment/screening, data collection during/after a trial, promote participant engagement during a long trial, or better protocol adherence.
...
I honestly didn’t do nearly as much here as I wanted to- partly because of the pilot (see next item) hitting full gear and requiring analysis, some fixes, and support.

- **Deep and wide dive into “pharma”.**

  - 1 ‘interview’ this week, really helpful.

- **Pilot update.**

  - I have a biggish pilot scheduled to start in the next two weeks (250 participants, weekly calls for a year…). They reached out with an ominous message about changes in plans. I am meeting with them this afternoon. 🤞

- **First pilot**

  - The first pilot hit high gear and mostly wrapped up this week!
  - It was small, but still revealed a lot of issues that needed to be fixed.

    - Status dashboard: when you have 1-2 calls a day it’s easy to manage, but beyond that, calls need to be categorized as completed, voicemail, interrupted, etc…and we need a dashboard showing the status of each patient.
    - We also saw gaps in how people approach the AI: they were treating it like an IVR, when it is much more capable than that. That can likely be fixed with some introductory material.

  - I fixed some things, and we made a list of the things to tackle before the next one.

- **Product development**

  - **Limited to things that came up through the pilot.**
  - **Minor**

    - Testing
    - Fix for a rare, but bad audio issue and some weird verbiage that pops up sometimes.

## This week

- **Market Development**

  - I’m pushing hard here. I have a bunch of outreach scheduled for Monday and Tuesday. The ambitious goal is 10 interviews for the following week.

- **End of week, limited: Product development**

  - **I want to limit that this week, since it is always more appealing than outreach.**
  - During the pilot, we discovered an infrequent, but serious issue

    - A couple patients picked up the phone with the TV or radio on. The audio model I use cannot distinguish between background and primary voices, so if the TV is on, the bot thinks you’re talking and never says anything.
    - There is 1 (just one!) product on the market that is good at this. It’s called Krisp. They charge a minimum of $5k a year, which is not crazy for a company with throughput, but for me, it’s a lot. I might have to make some major infrastructure changes to use them affordably… we’ll see. Right now the biggest issue is market development, so I’m going to limit this.

## Media Generation of the Week

I’ve shown you how Stock image services now let you change the race of the people in an image, or even add people to an image. However, the latest promise is that you can have continuity across your ads, basically the same person in different situations. “Historically” stock imagery AI has not enabled you to have the same person in multiple images, which could be important for consistent messaging.
...
It sucks for other reasons.

I then tried to test the limits of what it can do by putting myself in situations I will never get a picture of. It failed in interesting ways.

**I will never win the superbowl**

_@jon just won the superbowl and is dancing on the field with his helmet off_
...
_@jon has sideburns and a beard and is playing guitar at Woodstock_
